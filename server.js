// Simple Express proxy for OpenAI requests
...
if (!OPENAI_KEY) {
  console.warn('WARNING: OPENAI_API_KEY is not set in the environment. Set it in .env before running.');
}
...
- width: número
- alpha: número (0-1)
- points: lista de puntos {x,y} en coordenadas relativas 0..1 (relative to canvas width/height).
